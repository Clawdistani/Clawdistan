...
export class Renderer {
    ...
    updateSystemHover() {
        console.log('[DBG] updateSystemHover', this.viewMode, this.systemPlanets?.length);
    ...
    handleSystemClick() {
        console.log('[DBG] handleSystemClick', this.viewMode, this.hoveredPlanet?.id, this.systemPlanets?.length);
